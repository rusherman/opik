...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{shard}/${ANALYTICS_DB_DATABASE_NAME}/DATABASECHANGELOG', '{replica}')
ORDER BY ID
SETTINGS index_granularity = 8192
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{shard}/${ANALYTICS_DB_DATABASE_NAME}/DATABASECHANGELOGLOCK', '{replica}')
ORDER BY ID
SETTINGS index_granularity = 8192
...
RENAME TABLE ${ANALYTICS_DB_DATABASE_NAME}.DATABASECHANGELOGLOCK1 TO ${ANALYTICS_DB_DATABASE_NAME}.DATABASECHANGELOGLOCK;
--rollback RENAME TABLE ${ANALYTICS_DB_DATABASE_NAME}.DATABASECHANGELOGLOCK TO ${ANALYTICS_DB_DATABASE_NAME}.DATABASECHANGELOGLOCK1;